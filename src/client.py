...
def reset():
    ...
    return send_request(RESET_OP_CODE, {})
...
def assignment_create(
    ...
    return send_request(5, {
        "created": created, "parameter": parameter,
        "entity": entity, "tags": tags,
        "stage": stage, "triggered": triggered
    })
...
def feedback_create(
    ...
    return send_request(9, {
        "created": created, "output": output,
...
if __name__ == "__main__":
    """Демонстрация работы всех методов клиента."""
    ...
    print("\n-- Assignment --")
    print("Создать:", assignment_create(
        now, "param1", 1, "tag1", "init", 0
    ))
    print("Все:", assignment_get_all())
    print("По ID:", assignment_get_by_id(1))

    print("\n-- Feedback --")
    print("Создать:", feedback_create(
        now, "ok", "done", "none", 1, 0, 100
    ))
